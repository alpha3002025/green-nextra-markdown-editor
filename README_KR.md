...
강의 필기를 한다거나, 어떤 책을 읽은 내용들을 정리하거나, 유튜브 경제 방송등을 들을 때 캡쳐 이미지를 드래그앤 드랍으로 추가하거나 Youtube 링크를 추가할 때 Preview 기능이 지원되면 좋다는 생각을 해서 이 프로젝트를 시작하게 되었고, Terraform 강의 필기를 하다가 정리가 필요해서 내가 사용하기 위한 목적으로 이 프로젝트를 개설해서 본격적으로 진행하게 되었고 그 결과 이 프로젝트가 탄생하게 되었네요.✨✨<br/>
<br/>
